...
if loader=='fabric':
 p=out/'fabric.mod.json';j=json.loads(p.read_text());j['version']='0.8.0';j['depends'].update(minecraft=v,java='>=21' if v.startswith('1.') else '>=25',fabricloader='>=0.19.5',sodium='*');j['jars']=[{'file':'META-INF/jars/sodium.jar'}]
