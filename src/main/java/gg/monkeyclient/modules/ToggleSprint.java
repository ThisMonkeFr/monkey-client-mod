...
public class ToggleSprint extends Module {
 ...
 @Override public void onTick(){
  var mc=Minecraft.getInstance();var p=mc.player;if(p==null){flightPlayer=null;return;}
  if(p.isCreative()){
   if(flightPlayer!=p){restoreFlight();flightPlayer=p;originalFlight=p.getAbilities().getFlyingSpeed();lastApplied=originalFlight;}
 ...
 private void restoreFlight(){if(flightPlayer!=null){flightPlayer.getAbilities().setFlyingSpeed(originalFlight);flightPlayer=null;}}
