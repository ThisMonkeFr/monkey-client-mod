...
public final class GroupEditorScreen extends NativeScreen {
 ...
 @Override protected void onOpened(){picture("icon",icon);if(existing!=null)call("/social",new JsonObject(),r->{owner=str(r.getAsJsonObject("account"),"uuid").equals(str(existing,"owner"));rebuild();});}
